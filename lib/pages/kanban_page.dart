  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          children: [
            ...
            Container(
              ...
              child: TabBar(
                ...
                indicator: BoxDecoration(color: primaryColor, borderRadius: const BorderRadius.all(Radius.circular(15))),
                labelColor: Colors.white,
                unselectedLabelColor: blackColor,
                labelStyle: const TextStyle(fontWeight: FontWeight.bold, fontSize: 15, letterSpacing: 0.5),
                unselectedLabelStyle: const TextStyle(fontWeight: FontWeight.w500, fontSize: 14, color: blackColor),
                tabs: const [
                  Tab(text: "To Do"),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          // Default column "To Do", tapi di modal bisa pilih dropdown
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            _BottomNavItem(icon: Icons.bar_chart_outlined, label: "Kanban", onTap: () {}),
